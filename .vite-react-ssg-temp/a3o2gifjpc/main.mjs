...
import { X, AlertTriangle, RefreshCw, CheckCircle2, CheckCircle, Loader2, Download, Pause, Play, ArrowLeft, Bookmark, ArrowDownUp, ArrowUp, ChevronDown, Home, Search, Settings, Scissors, Crown, Cast, Share2, RotateCcw, RotateCw, AudioLines, Volume2, Mail, ShieldCheck, Headphones, SkipBack, SkipForward, Maximize2, VolumeX, ExternalLink, ChevronLeft, ChevronRight, Check, Sparkles, TrendingUp, Globe, ChevronUp, Radio, Heart, Music, Moon } from "lucide-react";
  ...
  render() {
    if (this.state.hasError) {
      return /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center min-h-screen bg-background px-6 text-center gap-4", children: [
        ...
        /* @__PURE__ */ jsx("h1", { className: "text-xl font-heading font-bold text-foreground", children: "Oups, quelque chose s'est mal passé" }),
...
const isNative$1 = typeof globalThis !== "undefined" && typeof globalThis.window !== "undefined" && typeof globalThis.window.Capacitor !== "undefined";
const BASE_URL = isNative$1 ? "https://api.podcastindex.org/api/1.0" : "/api/podcast";
function _d(s) {
  return atob(s);
}
...
function FavoritesProvider({ children }) {
  ...
  return /* @__PURE__ */ jsx(FavoritesContext.Provider, { value: { subscriptions, toggleSubscription, isSubscribed, markAsSeen, hasNewEpisodes, recent, addRecent }, children });
}
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0 flex flex-col justify-center", children: [
          ...
          /* @__PURE__ */ jsxs(
            "button",
            {
              ...
              className: `mt-3 px-4 py-2 rounded-full text-sm font-semibold flex items-center gap-2 w-fit transition-all ${subscribed ? "bg-primary text-primary-foreground" : "bg-accent text-foreground hover:bg-primary/20"}`,
              children: [
...
function FullScreenPlayer() {
  ...
  const handleClip = () => {
    ...
    {
      toast$1.error("✂️ Fonctionnalité Premium", { description: "Débloquez Premium pour créer des clips." });
      return;
    }
  };
  ...
  return /* @__PURE__ */ jsxs("div", { className: "fixed inset-0 z-50 bg-background flex flex-col overflow-y-auto animate-in slide-in-from-bottom duration-300", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between px-4 pb-2", style: { paddingTop: "max(env(safe-area-inset-top, 24px), 1.5rem)" }, children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
        ...
        /* @__PURE__ */ jsxs("button", { onClick: handleClip, className: "p-2 relative", "aria-label": "Clip", disabled: true, children: [
          /* @__PURE__ */ jsx(Scissors, { className: "w-5 h-5 text-muted-foreground/30" }),
          /* @__PURE__ */ jsx(Crown, { className: "w-2.5 h-2.5 text-amber-400 absolute -top-0.5 -right-0.5" })
        ] })
      ] }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0 space-y-4", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-2", children: [
            PLAYBACK_RATES.map((rate) => /* @__PURE__ */ jsxs(
              "button",
              {
            ...
            /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx(AudioLines, { className: "w-3.5 h-3.5" }),
                  "Voix",
                  /* @__PURE__ */ jsx(Crown, { className: "w-2.5 h-2.5 text-amber-400" })
                ]
              }
            )
          ] })
...
function FlagIcon({ lang, className = "w-6 h-4" }) {
  return /* @__PURE__ */ jsx("span", { className: `inline-block rounded-sm overflow-hidden shadow-sm ${className}`, children: FLAGS[lang] });
}
    ...
    "aside",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "px-4 pb-6 pt-4 space-y-3", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "flex items-center gap-3 px-4", children: LANGUAGE_OPTIONS.map((opt) => /* @__PURE__ */ jsx(
            "button",
            {
              onClick: () => setLanguage(opt.value),
              className: cn(
                "transition-all",
                language === opt.value ? "scale-125 drop-shadow-[0_0_6px_hsl(var(--primary)/0.5)]" : "opacity-50 hover:opacity-100 hover:scale-110 grayscale hover:grayscale-0"
              ),
              title: opt.label,
              children: /* @__PURE__ */ jsx(FlagIcon, { lang: opt.value, className: "w-7 h-5" })
            },
            opt.value
          )) }),
          /* @__PURE__ */ jsxs("p", { className: "px-4 text-[10px] text-muted-foreground leading-relaxed", children: [
            "© ",
...
function DesktopPlayerBar() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "hidden lg:flex items-center h-20 bg-secondary/60 backdrop-blur-lg border-t border-border px-6 gap-6", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 w-80 flex-shrink-0", children: [
      /* @__PURE__ */ jsx(
        "div",
        {
      ...
      /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1", children: [
        /* @__PURE__ */ jsx("p", { className: "text-sm font-heading font-bold bg-gradient-to-r from-[hsl(var(--primary))] to-[hsl(280,80%,60%)] bg-clip-text text-transparent truncate", children: currentEpisode.title }),
        /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground truncate", children: currentEpisode.feedTitle || "" })
      ] })
    ] }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 w-64 flex-shrink-0 justify-end", children: [
      /* @__PURE__ */ jsx("button", { onClick: openFullScreen, className: "p-2 rounded-full hover:bg-accent text-muted-foreground hover:text-foreground transition-colors", children: /* @__PURE__ */ jsx(Maximize2, { className: "w-4 h-4" }) }),
    ...
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsx("p", { className: "text-sm font-semibold text-foreground truncate", children: podcast.title }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground truncate", children: podcast.author })
          ] }),
          /* @__PURE__ */ jsx(
            "button",
            {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx(
          "div",
          {
            className: "aspect-square rounded-xl overflow-hidden bg-accent mb-2 shadow-lg group-active:scale-95 transition-transform",
...
function MarqueeText({ text, active = false, className = "" }) {
  ...
  return /* @__PURE__ */ jsxs("div", { ref: containerRef, className: "overflow-hidden", children: [
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex-1 flex flex-col overflow-hidden", children: [
    /* @__PURE__ */ jsx("div", { className: "bg-background px-4 pt-6 pb-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-3", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 min-w-0", children: [
        /* @__PURE__ */ jsx("img", { src: podcastSphereLogo, alt: "Podcast Sphere", className: "w-12 h-12 rounded-xl mix-blend-screen animate-logo-glow" }),
        /* @__PURE__ */ jsx("h1", { className: "text-2xl font-heading font-bold bg-gradient-to-r from-[hsl(220,90%,60%)] to-[hsl(280,80%,60%)] bg-clip-text text-transparent whitespace-nowrap", children: "Podcast Sphere" })
      ] }),
      /* @__PURE__ */ jsx(
        "button",
        {
              ...
              return /* @__PURE__ */ jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx("p", { className: "text-xs font-semibold text-foreground truncate", children: ep.title }),
                    /* @__PURE__ */ jsx("p", { className: "text-[10px] text-muted-foreground truncate", children: ep.feedTitle })
                  ]
                },
                ep.id
              );
...
function WelcomePage({ onComplete }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center min-h-screen bg-background px-6 py-10 text-center overflow-y-auto", children: [
    /* @__PURE__ */ jsxs("div", { className: "relative mb-6", children: [
      /* @__PURE__ */ jsx("div", { className: "absolute inset-0 rounded-full bg-primary/20 blur-3xl scale-150 animate-pulse" }),
      /* @__PURE__ */ jsx(
        "img",
        {
          src: podcastSphereLogo,
    ...
    /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-3 w-full max-w-xs mb-10", children: FEATURE_KEYS.map((key, i) => {
    ...
    /* @__PURE__ */ jsxs("div", { className: "w-full max-w-xs mb-8", children: [
    ...
    /* @__PURE__ */ jsx("p", { className: "text-[10px] text-muted-foreground mt-3 opacity-60", children: "Podcast Sphere v1.0" })
  ] });
}
...
const SearchPage = lazy(() => import("./assets/SearchPage-BqhOV3De.js").then((m) => ({ default: m.SearchPage })));
const LibraryPage = lazy(() => import("./assets/LibraryPage-DkLu5o5L.js").then((m) => ({ default: m.LibraryPage })));
const SettingsPage = lazy(() => import("./assets/SettingsPage-Ddo9s4w4.js").then((m) => ({ default: m.SettingsPage })));
...
function AppContentInner() {
  ...
  if (showWelcome) {
    return /* @__PURE__ */ jsx(WelcomePage, { onComplete: handleWelcomeComplete });
  }
  const renderContent = () => {
    if (detailPodcast) {
...
export {
  ...
  Button as B,
  CachedImage as C,
  AlertDialogFooter as D,
  AlertDialogCancel as E,
  ...
  cn as c,
  createRoot,
  useFavoritesContext as d,
  useDownloads as e,
  clearHistory as f,
  getListenHistory as g,
  MarqueeText as h,
  requestAllPermissions as i,
  useSleepTimer as j,
  podcastSphereLogo as k,
  Select as l,
  SelectTrigger as m,
  SelectValue as n,
  SelectContent as o,
  preCacheImages as p,
  SelectItem as q,
  removeFromHistory as r,
  searchPodcasts as s,
  SLEEP_TIMER_OPTIONS as t,
  useTranslation as u,
  AlertDialogTrigger as v,
  AlertDialogContent as w,
  AlertDialogHeader as x,
  AlertDialogTitle as y,
  AlertDialogDescription as z
};
